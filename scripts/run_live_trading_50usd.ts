  ...
  try {
    ...
    const risk_config: RiskConfig = {
      ...
      take_profit_targets: [
        ...
        { percentage: 50, target_profit_pct: 0, is_trailing: true, trailing_callback_pct: 3, activation_profit_pct: 7 }  // 第3批: 40%仓位 激活+5%后开始跟踪(价格回调3%平仓)
      ],
    ...
    // ⭐ 设置追高阈值为7%（避免追高）
    trading_system.set_chase_high_threshold(7);
